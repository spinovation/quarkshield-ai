...
-- Seed initial SBOM components for demonstration & enterprise testing
...
VALUES
  ('sbom-comp-01', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/payments-microservice', 'package.json', 'jsonwebtoken', '8.5.1', 'npm', 'pkg:npm/jsonwebtoken@8.5.1', 'MIT', true, 1, 'critical', '[{"cveId": "CVE-2022-23529", "title": "Insecure Key Retrieval Remote Code Execution", "cvssScore": 9.8, "severity": "critical", "fixedVersion": "^9.0.2", "remediationCmd": "npm install jsonwebtoken@^9.0.2", "description": "jsonwebtoken library allows remote code execution when verifying untrusted tokens with malicious secret key objects."}]'::jsonb),
  ('sbom-comp-02', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/payments-microservice', 'package.json', 'axios', '0.21.1', 'npm', 'pkg:npm/axios@0.21.1', 'MIT', true, 2, 'high', '[{"cveId": "CVE-2023-45857", "title": "Cross-Site Request Forgery (CSRF) Bypass", "cvssScore": 8.8, "severity": "high", "fixedVersion": "^1.7.4", "remediationCmd": "npm install axios@^1.7.4", "description": "Axios does not clear confidential custom headers during cross-domain redirects."}, {"cveId": "CVE-2021-3749", "title": "Regular Expression Denial of Service (ReDoS)", "cvssScore": 7.5, "severity": "high", "fixedVersion": "^0.21.2", "remediationCmd": "npm install axios@^1.7.4", "description": "Regular expression denial of service in trim method."}]'::jsonb),
  ('sbom-comp-03', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/payments-microservice', 'package.json', 'lodash', '4.17.20', 'npm', 'pkg:npm/lodash@4.17.20', 'MIT', true, 1, 'high', '[{"cveId": "CVE-2021-23337", "title": "Command Injection in template function", "cvssScore": 7.2, "severity": "high", "fixedVersion": "^4.17.21", "remediationCmd": "npm install lodash@^4.17.21", "description": "Prototype pollution and command injection vulnerability in lodash template parsing."}]'::jsonb),
  ('sbom-comp-04', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/core-api-gateway', 'package.json', 'qs', '6.15.3', 'npm', 'pkg:npm/qs@6.15.3', 'BSD-3-Clause', true, 2, 'high', '[{"cveId": "GHSA-x5fp-wj9c-mxmx", "title": "Array-limit bypass via bracket-key comma parsing", "cvssScore": 7.5, "severity": "high", "fixedVersion": "^6.15.4", "remediationCmd": "npm install qs@^6.15.4", "description": "qs library allows array-limit bypass causing unexpected memory allocation spikes."}, {"cveId": "GHSA-4mjr-xmp4-gh2g", "title": "Denial of Service via Attacker Controlled isBuffer", "cvssScore": 5.3, "severity": "medium", "fixedVersion": "^6.15.4", "remediationCmd": "npm install qs@^6.15.4", "description": "Prototype denial of service vulnerability in parameter formatting."}]'::jsonb),
  ('sbom-comp-05', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/risk-analyzer', 'requirements.txt', 'requests', '2.28.1', 'pypi', 'pkg:pypi/requests@2.28.1', 'Apache-2.0', true, 1, 'medium', '[{"cveId": "CVE-2023-32681", "title": "Unintended Proxy-Authorization Header Leak", "cvssScore": 6.1, "severity": "medium", "fixedVersion": ">=2.31.0", "remediationCmd": "pip install requests>=2.31.0", "description": "Requests forwards sensitive Proxy-Authorization headers to destination origin on HTTP 30x redirects."}]'::jsonb),
  ('sbom-comp-06', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/risk-analyzer', 'requirements.txt', 'urllib3', '1.26.17', 'pypi', 'pkg:pypi/urllib3@1.26.17', 'MIT', true, 1, 'high', '[{"cveId": "CVE-2023-45803", "title": "Request Body Stripping on 303 Redirect", "cvssScore": 7.5, "severity": "high", "fixedVersion": ">=2.0.7", "remediationCmd": "pip install urllib3>=2.0.7", "description": "urllib3 fails to remove request bodies when following 303 See Other redirects, causing server desynchronization."}]'::jsonb),
  ('sbom-comp-07', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/crypto-signer', 'go.mod', 'golang.org/x/crypto', 'v0.12.0', 'golang', 'pkg:golang/golang.org/x/crypto@v0.12.0', 'BSD-3-Clause', true, 1, 'medium', '[{"cveId": "CVE-2023-48795", "title": "Terrapin SSH Protocol Prefix Truncation", "cvssScore": 5.9, "severity": "medium", "fixedVersion": "v0.17.0", "remediationCmd": "go get golang.org/x/crypto@v0.17.0", "description": "Terrapin attack allows man-in-the-middle attacker to truncate extension negotiation messages during SSH handshake."}]'::jsonb),
  ('sbom-comp-08', 'SPINOVATIONCORP', 'endpoint', 'macbook-pro-ciso.local', '/usr/local/Cellar', 'openssl', '3.0.2', 'os_pkg', 'pkg:generic/openssl@3.0.2', 'Apache-2.0', true, 1, 'medium', '[{"cveId": "CVE-2023-3817", "title": "Excessive Time Checking DH Parameters", "cvssScore": 5.3, "severity": "medium", "fixedVersion": "3.0.10+", "remediationCmd": "brew upgrade openssl@3", "description": "Excessive CPU consumption when processing specially crafted Diffie-Hellman parameters."}]'::jsonb),
  ('sbom-comp-09', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/payments-microservice', 'package.json', '@noble/post-quantum', '0.2.0', 'npm', 'pkg:npm/@noble/post-quantum@0.2.0', 'MIT', false, 0, 'none', '[]'::jsonb),
  ('sbom-comp-10', 'SPINOVATIONCORP', 'git_repo', 'https://github.com/spinovation/payments-microservice', 'package.json', 'express', '4.22.2', 'npm', 'pkg:npm/express@4.22.2', 'MIT', false, 0, 'none', '[]'::jsonb),
  ('sbom-comp-11', 'AMBEROON', 'git_repo', 'https://github.com/amberoon/aml-risk-engine', 'requirements.txt', 'cryptography', '39.0.1', 'pypi', 'pkg:pypi/cryptography@39.0.1', 'Apache-2.0', true, 1, 'high', '[{"cveId": "CVE-2023-49083", "title": "NULL Pointer Dereference in PKCS7 Loading", "cvssScore": 7.5, "severity": "high", "fixedVersion": ">=41.0.6", "remediationCmd": "pip install cryptography>=41.0.6", "description": "Calling load_pem_pkcs7_certificates or load_der_pkcs7_certificates with invalid PKCS7 structures causes a crash."}]'::jsonb),
  ('sbom-comp-12', 'AMBEROON', 'git_repo', 'https://github.com/amberoon/aml-risk-engine', 'requirements.txt', 'fastapi', '0.110.0', 'pypi', 'pkg:pypi/fastapi@0.110.0', 'MIT', false, 0, 'none', '[]'::jsonb)
ON CONFLICT (id) DO NOTHING;
