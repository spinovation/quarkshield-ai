...
echo.
echo Cleaning up files and shortcuts...
del /f /q "%USERPROFILE%\Desktop\QuarkShield Post-Quantum Guard.lnk" >nul 2>&1
del /f /q "%APPDATA%\Microsoft\Windows\Start Menu\Programs\QuarkShield Post-Quantum Guard.lnk" >nul 2>&1
